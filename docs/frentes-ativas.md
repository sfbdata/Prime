...
|---|---|---|---|---|---|
| `cobranca-importar-cadastro-acordos` | Cobrança (importação) | **sim** (coluna `competencia` + backfill) | `.gitignore` (regra de PII das planilhas) | implementando | `origin/master` |
