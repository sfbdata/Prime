...
| `e2-abstracao-storage` | **transversal** — Shared + 9 domínios | **não** | `app/src/Shared/`, `app/config/services.yaml`, `app/src/Shared/CLAUDE.md`, + 35 arquivos de produção | **E2.4B entregue**: peça nova/editada, cópia do acervo e download do Drive gravam por chave; export e referências de peça leem por chave. E2.0 `d15535fd`, congelamento `80ac07cb`, E2.1 `f37d5706`, E2.2 `fbf5b778`, E2.3 `84bded8d`, E2.4A `7d266a1c`. D1–D16 ratificadas. Próxima: E2.5 (exclusões e purga), aguardando decisões do dono | `origin/master` @ `c365fe72` |
