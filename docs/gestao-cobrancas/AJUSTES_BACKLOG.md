...
## 7. Formulário de acordo inteligente + abrir/editar acordo — `🔨 EM ANDAMENTO (fatias 1 e 2 commitadas; faltam 3 e 4)` — spec `docs/specs/cobranca-ajuste7-acordo-inteligente.md`
