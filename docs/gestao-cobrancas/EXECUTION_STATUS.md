...
> **PENDÊNCIA ABERTA (perf): `docs/gestao-cobrancas/PLANO_OTIMIZACAO_QUERIES.md`** — eliminar o N+1 em TODAS as telas de Cobrança reusando o batch-load do Dashboard. Dashboard ✅ feito (`2a9315c`, 2731→~7 queries). Falta: P1 Central de Alertas, P2 Visão da Carteira, P3 Lista de Casos, P4 menores (Lista de Carteiras + dedupe do Detalhe). Infra reutilizável (`derivarSaldos` + 6 métodos `*DosCasos`) já pronta.
