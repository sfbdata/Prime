...
### 1. Smoke — é do dono, e tem um ponto sem rede

- sidebar diz "Push Processual"
- as 3 telas: listagem, publicação, OABs
- **clicar numa notificação antiga** → é o teste do 301
- 🔴 **digitar "djen" na busca do menu** → **único ponto sem teste automatizado**: o alias é
  JavaScript (`data-busca-alias`) e a suíte PHPUnit não executa JS. Conferido só por inspeção.
- tela de papéis → só mostra o nome novo **depois da migration rodar em prod**
