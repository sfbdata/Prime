...
#[CoversClass(ExcluirObservacaoFinanceiraUseCase::class)]
final class ExcluirObservacaoFinanceiraUseCaseTest extends TestCase
{
    private EntityManagerInterface&MockObject $em;
    private ExcluirObservacaoFinanceiraUseCase $useCase;
    ...
    protected function setUp(): void
    {
        ...
        $this->useCase = new ExcluirObservacaoFinanceiraUseCase($this->em);
        $this->tenant  = new Tenant();
        $this->autor   = (new User())->setEmail('autor@test.com');
    }

    private function novaObservacao(): PastaObservacaoFinanceira
    {
    ...
    public function testNaoAutorLancaExcecao(): void
    {
        ...
        $this->expectException(ObservacaoFinanceiraNaoExcluivelException::class);
